    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse show">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="search_exercises.php">Search DB</a></li>
                <li class="nav-item"><a class="nav-link active" href="manage_exercises.php">Manage DB</a></li>
            </ul>
        </div>
    </div>
</nav>
